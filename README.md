...
```
#### Instructions
1. Clone project from this [https://github.com/booktay/srclus.git](https://github.com/booktay/srclus.git) and Go to this directory
2. Follow this instructions in [Core](core/) for Prepare datas, Word2vec Model, Clustering, API Backend
3. Follow this instructions in [Client](client/) for Frontend
4. Open your browser without CORS
    **Testing on Chrome**
